...
public class sample3_9_3 {
    ...
    static public void main(String[] args) throws Exception {
        ...
        // 出力ファイル指定
        File fileOUT = new File("output/wikidata_test-output.ttl");
        // 出力用のファイルのWriterの設定
            ...
            try (QueryExecution qexec = QueryExecutionHTTP.create()
                ...
                while (rs.hasNext()) {
                    ...
                    if (wikiPage != null) {
                        ...
                        String wikiPageName = wikiPageUri.replace("http://wikidata.dbpedia.org/resource/", "");
