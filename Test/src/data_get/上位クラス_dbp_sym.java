...
public class 上位クラス_dbp_sym {
    ...
    static public void main(String[] args) throws Exception {
        ...
        // 出力ファイル指定
        File fileOUT = new File("output_dis/上位クラス_dbp_sym.ttl");
        // 出力用のファイルのWriterの設定
                ...
                try (QueryExecution qexec = QueryExecutionHTTP.create()
                	...
                	while (rsDBpedia.hasNext()) {
                        ...
                        if (symID != null) {
                            ...
                            String symPageName = symUri2.replace("http://wikidata.dbpedia.org/resource/", "");
